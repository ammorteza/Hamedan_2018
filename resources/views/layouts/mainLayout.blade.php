                        ...
                        @foreach($pageInfo->pageHeaderImg as $pageImg)
                            <li class="is-active orbit-slide">
                                ...
                                @elseif ($pageInfo->headerType->phtType == 'PUBLIC')
                                    <img style="height: 50vh;width: 100vw;" class="background-cover orbit-image top-slider-simple image-black-overlay" src="{{ asset($pageImg->image->gPath . '?v' . config('app.version')) }}" alt="{{ $pageInfo->pEnSubject }}">
                                    <figcaption class="orbit-caption align-center my-text-shadow-effect">
                                        @if($lan == 'fa')
